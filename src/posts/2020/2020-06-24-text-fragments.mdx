...
**Select any text** on this page and <Highlight /> again to see the highlighted text snippet.
...
*[WICG]: W3C Incubator Community Group

[^wicg]: I was not aware of this group before.
