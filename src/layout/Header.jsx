        ...
        <div className="logo h-card p-author">
          ...
          <div className="about">
            ...
            <div className="about__social">
              <a href="https://twitter.com/rmnvsl" className="u-url" title="twitter" rel="me">
                <i className="icon-twitter"></i>
                <span className="sr-only">twitter</span>
              </a>
              <a href="https://github.com/crazko" className="u-url" title="github" rel="me">
                <i className="icon-github-circled"></i>
                <span className="sr-only">github</span>
              </a>
              <a
                href="https://stackoverflow.com/users/5549874/crazko"
                className="u-url"
              ...
              <a href="https://dev.to/rmnvsl" className="u-url" title="dev.to" rel="me">
                <i className="icon-devto"></i>
                <span className="sr-only">dev.to</span>
              </a>
              <a href="https://www.linkedin.com/in/veselyroman" className="u-url" title="linkedin" rel="me">
                <i className="icon-linkedin"></i>
                <span className="sr-only">linkedin</span>
              </a>
              <a href="https://mastodon.social/@romanvesely" className="u-url" title="mastodon" rel="me">
                <i className="icon-mastodon"></i>
                <span className="sr-only">mastodon</span>
              </a>
              <a href="https://www.goodreads.com/user/show/53605807" className="u-url" title="goodreads" rel="me">
