...
Just a small note aside from the interview - immediately after the discussion started people went to sli.do to [ask their question](link with the list of all questions). They were very creative, which, I suppose, was caused by the late hour of the day filled with great presentations. One of them, not a question that'd fulfill a description of "request for information" got the attention of the many:
